...
export const EngineeringSafetyIcon: React.FC<{ className?: string }> = ({ className = "w-12 h-12" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        {/* Hard Hat */}
        <path d="M2 13.5A2.5 2.5 0 0 1 4.5 11h15a2.5 2.5 0 0 1 2.5 2.5V17a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-3.5z"/>
        <path d="M12 11V3.5a2.5 2.5 0 0 1 2.5-2.5h0A2.5 2.5 0 0 1 17 3.5V11"/>
        {/* Gear */}
        <circle cx="12" cy="16" r="2"/>
        <path d="M12 13.5v.5m0 4v.5m2.5-2.5h.5m-6 0h.5m2-1.5l-.7.7m-2.6 2.6l-.7.7m4.4-4.4l.7.7m-4.4-4.4l.7.7"/>
    </svg>
);

export const OccupationalHealthIcon: React.FC<{ className?: string }> = ({ className = "w-12 h-12" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M2 12.55A10 10 0 0 1 12 5.5a10 10 0 0 1 10 7.05"/>
        <path d="M12 5.5V2"/>
        <path d="M20 12.55V17a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-4.45"/>
...
export const ChatBubbleIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 01-2.53-.372A5.56 5.56 0 016.75 21a5.56 5.56 0 01-2.22-1.352l-.24-.24a.82.82 0 01-.24-.582V16.5a9 9 0 01-3-5.25c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" />
    </svg>
);
